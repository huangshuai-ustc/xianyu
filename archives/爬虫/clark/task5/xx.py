...
def get_some_data(ApplicationType):
    ...
    user_data_dir = r"--user-data-dir=C:\Users\fjwyz\AppData\Local\Microsoft\Chrome\User Data"
    ...
    df.to_excel('{}.xlsx'.format(ApplicationType), index=False, header=header)
    print("Data collection complete and saved to {}.xlsx".format(ApplicationType))


if __name__ == '__main__':
    ApplicationType = 'GPDQ - agricultural to C3 dwellinghouse'
