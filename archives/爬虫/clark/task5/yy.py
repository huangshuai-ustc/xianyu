...
def get_data():
    ...
    # for _ in range(len(Application_Number)):
    #     time.sleep(0.5)
    #     try:
    #         driver.find_element(By.CSS_SELECTOR,
    #                             '#results > div > div > div.results > div > table > tbody > tr:nth-child({}) > td:nth-child(1) > strong > a'.format(
    #                                 _ + 1)).click()
...
for i in range(int(result_number)-1):
    ...
    time.sleep(0.5)
    get_data()
data = [Proposals, Locations, Application_Numbers]
