...
def get_data(Application_Type, Decision):
    ...
    for i in range(len(start_time)):
        ...
        driver.find_element(By.CSS_SELECTOR, '#description').send_keys(Decision)
    ...
    df.to_excel('./{}_{}.xlsx'.format(Application_Type.replace('/', ''), Decision), index=False, header=header)


if __name__ == '__main__':
    Application_Type = 'Full Planning Permission'
    Description = 'change of use OR conversion OR use as'
    for i in Description.split(' OR '):
