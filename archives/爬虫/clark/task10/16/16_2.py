...
def get_data(Application_Type, proposal):
    ...
    for i in range(len(start_time)):
        ...
        driver.find_element(By.CSS_SELECTOR, '#proposal').send_keys(proposal)
    ...
    df.to_excel('./{}_{}.xlsx'.format(Application_Type.replace('/', ''), proposal), index=False, header=header)


if __name__ == '__main__':
    Application_Type = 'Full Application'
    proposal = 'change of use OR conversion OR use as'
    # get_data(Application_Type)
    for i in proposal.split(' OR '):
