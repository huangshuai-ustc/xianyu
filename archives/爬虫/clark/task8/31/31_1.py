...
url = 'https://planning.dacorum.gov.uk/publicaccess/search.do?action=advanced'
...
if __name__ == '__main__':
    # Application_Type = 'Agricultural to Resi. Prior Approval'
    # Application_Type = 'Class E to Residential Prior Approval'
    Application_Type = 'Retail to Residential Prior Approval'
