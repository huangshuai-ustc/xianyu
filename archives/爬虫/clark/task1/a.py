...
def get():
    ...
    driver.get('https://shenzhen.anjuke.com/community/p1/')
    time.sleep(3)
    ...
    def get_data():
        for i in range(25):
            ...
            data_element_jg_00 = driver.find_element(By.CSS_SELECTOR,
                                                     '#__layout > div > div.props-main.w-1170 > div.props-body > '
                                                     'div.props-right > div.maininfo > div.house-price > div > '
                                                     'span.average').text  # 这里提取的是average价格
            data_element_wy_01 = driver.find_element(By.CSS_SELECTOR,
                                                     '#__layout > div > div.props-main.w-1170 > div.props-body > '
                                                     'div.props-right > div.maininfo > div.info > div > div:nth-child(1) '
                                                     '> div.hover > div.value.value_0').text  # 这里提取的是物业类型
            data_element_qs_02 = driver.find_element(By.CSS_SELECTOR,
                                                     '#__layout > div > div.props-main.w-1170 > div.props-body > '
                                                     'div.props-right > div.maininfo > div.info > div > div:nth-child(2) '
                                                     '> div.hover > div.value.value_1').text  # 这里提取的是权属类型
            data_element_jg_03 = driver.find_element(By.CSS_SELECTOR,
                                                     '#__layout > div > div.props-main.w-1170 > div.props-body > '
                                                     'div.props-right > div.maininfo > div.info > div > div:nth-child(3) '
                                                     '> div.hover > div.value.value_2').text  # 这里提取的是竣工时间
            data_element_nx_04 = driver.find_element(By.CSS_SELECTOR,
                                                     '#__layout > div > div.props-main.w-1170 > div.props-body > '
                                                     'div.props-right > div.maininfo > div.info > div > div:nth-child(4) '
                                                     '> div.hover > div.value.value_3').text  # 这里提取的是产权年限
            data_element_hs_05 = driver.find_element(By.CSS_SELECTOR,
                                                     '#__layout > div > div.props-main.w-1170 > div.props-body > '
                                                     'div.props-right > div.maininfo > div.info > div > div:nth-child(5) '
                                                     '> div.hover > div.value.value_4').text  # 这里提取的是总户数
            data_element_jm_06 = driver.find_element(By.CSS_SELECTOR,
                                                     '#__layout > div > div.props-main.w-1170 > div.props-body > '
                                                     'div.props-right > div.maininfo > div.info > div > div:nth-child(6) '
                                                     '> div.hover > div.value.value_5').text  # 这里提取的是总建筑面积
            data_element_rj_07 = driver.find_element(By.CSS_SELECTOR,
                                                     '#__layout > div > div.props-main.w-1170 > div.props-body > '
                                                     'div.props-right > div.maininfo > div.info > div > div:nth-child(7) '
                                                     '> div.hover > div.value.value_6').text  # 这里提取的是容积率
            data_element_lh_08 = driver.find_element(By.CSS_SELECTOR,
                                                     '#__layout > div > div.props-main.w-1170 > div.props-body > '
                                                     'div.props-right > div.maininfo > div.info > div > div:nth-child(8) '
                                                     '> div.hover > div.value.value_7').text  # 这里提取的是绿化率
            data_element_jl_09 = driver.find_element(By.CSS_SELECTOR,
                                                     '#__layout > div > div.props-main.w-1170 > div.props-body > '
                                                     'div.props-right > div.maininfo > div.info > div > div:nth-child(9) '
                                                     '> div.hover > div.value.value_8').text  # 这里提取的是建筑类型
            ...
            result.append(
                [data_element_jg_00, data_element_wy_01, data_element_qs_02, data_element_jg_03, data_element_nx_04,
                 ...
                 data_element_cq_15, data_element_cq_16, data_element_cq_17, data_element_cq_18, data_element_cq_19])
            driver.back()
    get_data()
    for i in range(49):
        driver.find_element(By.CSS_SELECTOR,
