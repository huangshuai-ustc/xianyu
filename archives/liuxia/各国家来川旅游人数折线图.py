...
df_nko, df_in, df_indo, df_jp = df[df['国家'] == '朝鲜'], df[df['国家'] == '印度'], df[df['国家'] == '印度尼西亚'], df[
    df['国家'] == '日本']
df_ma, df_mong, df_fe, df_si = df[df['国家'] == '马来西亚'], df[df['国家'] == '蒙古'], df[df['国家'] == '菲律宾'], df[
    df['国家'] == '新加坡']
...
df_nam, df_ca, df_am, df_oc = df[df['国家'] == '北美洲'], df[df['国家'] == '加拿大'], df[df['国家'] == '美国'], df[
    df['国家'] == '大洋洲及太平洋地区']
df_as, df_nsi = df[df['国家'] == '澳大利亚'], df[df['国家'] == '新西兰']
x = df_nko['年份']
y1, y2, y3, y4 = df_nko['y'], df_in['y'], df_indo['y'], df_jp['y']
y5, y6, y7, y8 = df_ma['y'], df_mong['y'], df_fe['y'], df_si['y']
y9, y10, y11, y12 = df_sko['y'], df_th['y'], df_eu['y'], df_eng['y']
y13, y14, y15, y16 = df_ge['y'], df_fr['y'], df_it['y'], df_he['y']
y17, y18, y19, y20 = df_pu['y'], df_swe['y'], df_swi['y'], df_ru['y']
y21, y22, y23, y24 = df_nam['y'], df_ca['y'], df_am['y'], df_oc['y']
y25, y26 = df_as['y'], df_nsi['y']
...
plt.ylabel("游客数/万", fontdict={'size': 16})
plt.title("2013-2018年间各国家或地区来川旅游人数折线图", fontdict={'size': 20})
plt.show()
